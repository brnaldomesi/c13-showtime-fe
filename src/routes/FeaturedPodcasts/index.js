  ...
  return (
    <div className={classes.root}>
      ...
      <Box display="flex">
        ...
        <Box mb={2}>
          <Button color="primary" variant="contained" component={Link} to="/feat/new">
      ...
      {featuredPodcastsLoading ? (
        ...
        <>
          {fpods.map(featuredPodcast => (
            <FeaturedPodcast key={featuredPodcast.id} featuredPodcast={featuredPodcast.featuredPodcasts} />
          ))}
        </>
      )}
    </div>
